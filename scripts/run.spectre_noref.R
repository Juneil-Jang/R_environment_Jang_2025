...
############################################################################################################ Check for real!!
  ...
  # aligned.dat <- cyCombine::cyCombine(
  #   data = cell.dat,
  #   batch = batch.col,
  #   markers = cellular.cols,
  #   method = "MNN"  # mutual nearest neighbors
  # )
...
############################################################################################################ Check for real!!
  ...
  cell.dat.aligned <- run.umap(cell.dat.aligned, use.cols = aligned.cols)
    
  make.colour.plot(cell.dat.aligned, "UMAP_X", "UMAP_Y", batch.col, col.type = 'factor', filename = "Aligned batches.png")
  make.colour.plot(cell.dat.aligned, "UMAP_X", "UMAP_Y", group.col, col.type = 'factor', filename = "Aligned groups.png")
  make.colour.plot(cell.dat.aligned, "UMAP_X", "UMAP_Y", donor.col,col.type = 'factor', filename = "Aligned Donors.png")
  make.colour.plot(cell.dat.aligned, "UMAP_X", "UMAP_Y", sample.col,col.type = 'factor', filename = "Aligned Samples.png")
  make.colour.plot(cell.dat.aligned, "UMAP_X", "UMAP_Y", "Alignment_MC_aligned", col.type = 'factor', add.label = TRUE, filename = "Aligned metaclusters.png")

  make.multi.plot(cell.dat.aligned, "UMAP_X", "UMAP_Y", aligned.cols, figure.title = "Aligned  markers - fine",save.each.plot = TRUE)
   
  ### Finalsie data ############################################################
    
  cell.dat <- cell.dat.aligned # excluding the bulk CD4 which are used for batch control
